...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!--The content below is only a placeholder and can be replaced.-->\n<!--app-menu></app-menu-->\n<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\">\n<div style=\"text-align:center\">\n  <h1>\n    ¡{{nuevoJuego.nombre}}!\n  </h1>\n </div>\n\n   <label class=\"ingrese\" [hidden]=\"ocultarIngrese\"><strong>Ingrese un numero:  </strong></label>  <input id=\"ingrese\" [hidden]=\"ocultarIngrese\" [(ngModel)]=\"nuevoJuego.numeroIngresado\" placeholder=\"ingrese numero\" name=\"numeroIngresado\" type=\"text\" class=\"form-control\"/>\n    <!-- <h1>{{nuevoJuego.numeroIngresado}}  </h1> -->\n \n    <h2 [hidden]=\"ocultarVerificar\"><button  *ngIf=\"nuevoJuego.numeroSecreto!=0\" (click)=\"verificar()\">Verificar</button></h2>\n \n    <h2><button *ngIf=\"nuevoJuego.numeroSecreto==0 \" (click)=\"generarnumero()\">Jugar al Número Secreto</button></h2>\n \n    <h3 style=\"text-align: center\"><p [hidden]=\"ocultarEsperando\" ><i class=\"fa fa-spinner fa-spin\"></i>Esperando que ingrese un número</p></h3>\n\n    <h3 [hidden]=\"!nuevoJuego.gano\" style=\"text-align: center\">¡Usted adivino el número!</h3>\n    <!-- <h3 [hidden]=\"nuevoJuego.gano\">usted aún no gano </h3> -->\n\n<div id=\"snackbar\">{{Mensajes}}</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div style=\"text-align:center\">\n    <h1> ¡{{nuevoJuego.nombre}}! </h1>\n</div>\n<div *ngIf=\"!jugando\">\n  <h2 style=\"text-align:center\"><button  (click)=\"NuevoJuego()\">Jugar al Ta-Te-Ti </button></h2>\n</div>\n<div *ngIf=\"jugando\" class=\"col-6 generalShadow\" \n  style=\"background-color: lightgreen; border-radius: 15px; margin-top:50px; margin-left: 25%;\">\n  <div style=\"width:100%\" class=\"pull-center\">\n    <div class=\"row\">\n      <div class=\"col-4 celda1 tatetiValue celda\" (click)=\"juegaJugador(0)\">{{celdas[0].jugador}}</div>\n      <div class=\"col-4 celda2 tatetiValue celda\" (click)=\"juegaJugador(1)\">{{celdas[1].jugador}}</div>\n      <div class=\"col-4 celda3 tatetiValue celda\" (click)=\"juegaJugador(2)\">{{celdas[2].jugador}}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-4 celda4 tatetiValue celda\" (click)=\"juegaJugador(3)\">{{celdas[3].jugador}}</div>\n      <div class=\"col-4 celda5 tatetiValue celda\" (click)=\"juegaJugador(4)\">{{celdas[4].jugador}}</div>\n      <div class=\"col-4 celda6 tatetiValue celda\" (click)=\"juegaJugador(5)\">{{celdas[5].jugador}}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-4 celda7 tatetiValue celda\" (click)=\"juegaJugador(6)\">{{celdas[6].jugador}}</div>\n      <div class=\"col-4 celda8 tatetiValue celda\" (click)=\"juegaJugador(7)\">{{celdas[7].jugador}}</div>\n      <div class=\"col-4 celda9 tatetiValue celda\" (click)=\"juegaJugador(8)\">{{celdas[8].jugador}}</div>\n    </div>\n  </div>\n</div>\n\n<div id=\"snackbar\">{{mensaje}}</div>\n");
...
class JuegoAdivina extends _juego__WEBPACK_IMPORTED_MODULE_1__["Juego"] {
...
class JuegoTaTeTi extends _juego__WEBPACK_IMPORTED_MODULE_1__["Juego"] {
    constructor(nombre, gano, jugador) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\nform {\r\n    border: 5px solid #00008b;\r\n    padding: 80px;\r\n    background:gray;\r\n\r\n}\r\n\r\ninput[type=text], input[type=password] {\r\n    width: 15%;\r\n    padding: 12px 20px;\r\n    margin: 8px 0;\r\n    display: inline-block;\r\n    border: 1px solid #ccc;\r\n    box-sizing: border-box;\r\n    margin-left: 2%;\r\n    margin-top: 10vh;\r\n}\r\n\r\nbutton {\r\n    background-color: #4CAF50;\r\n    color: white;\r\n    padding: 14px 20px;\r\n    margin: 8px 0;\r\n    border: none;\r\n    cursor: pointer;\r\n    width: 100%;\r\n    margin-top:10vh;\r\n}\r\n\r\nbutton:hover {\r\n    opacity: 0.8;\r\n}\r\n\r\n.cancelbtn {\r\n    width: auto;\r\n    padding: 10px 18px;\r\n    background-color: #f44336;\r\n}\r\n\r\n.aceptbtn {\r\n    width: auto;\r\n    padding: 10px 18px;\r\n    background-color: #3664F4;\r\n}\r\n\r\n.imgcontainer {\r\n    text-align: center;\r\n    margin: 24px 0 12px 0;\r\n}\r\n\r\nimg.avatar {\r\n    width: 40%;\r\n    border-radius: 50%;\r\n}\r\n\r\n.container {\r\n    padding: 16px;\r\n}\r\n\r\nspan.psw {\r\n    float: right;\r\n    padding-top: 16px;\r\n}\r\n\r\n/* Change styles for span and cancel button on extra small screens */\r\n\r\n@media screen and (max-width: 300px) {\r\n    span.psw {\r\n       display: block;\r\n       float: none;\r\n    }\r\n    .cancelbtn {\r\n       width: 100%;\r\n    }\r\n}\r\n\r\n#snackbar {\r\n    visibility: hidden;\r\n    min-width: 250px;\r\n    margin-left: -125px;\r\n   \r\n    color: #fff;\r\n    text-align: center;\r\n    border-radius: 2px;\r\n    padding: 16px;\r\n    position: fixed;\r\n    z-index: 1;\r\n    left: 50%;\r\n    bottom: 30px;\r\n    font-size: 17px;\r\n}\r\n\r\n#snackbar.Ganador {\r\n    background-color: #059F2F;\r\n}\r\n\r\n#snackbar.Perdedor {\r\n    background-color: #2271b3;\r\n}\r\n\r\n#snackbar.show {\r\n    visibility: visible;\r\n    -webkit-animation: fadein 0.5s, fadeout 0.5s 2.5s;\r\n    animation: fadein 0.5s, fadeout 0.5s 2.5s;\r\n}\r\n\r\n.ingrese {\r\n    font-size: 30px;\r\n    margin-left: 30%;\r\n}\r\n\r\n@-webkit-keyframes fadein {\r\n    from {bottom: 0; opacity: 0;} \r\n    to {bottom: 30px; opacity: 1;}\r\n}\r\n\r\n@keyframes fadein {\r\n    from {bottom: 0; opacity: 0;}\r\n    to {bottom: 30px; opacity: 1;}\r\n}\r\n\r\n@-webkit-keyframes fadeout {\r\n    from {bottom: 30px; opacity: 1;} \r\n    to {bottom: 0; opacity: 0;}\r\n}\r\n\r\n@keyframes fadeout {\r\n    from {bottom: 30px; opacity: 1;}\r\n    to {bottom: 0; opacity: 0;}\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("input[type=text], input[type=password] {\r\n    width: 50%;\r\n    padding: 12px 20px;\r\n    margin: 8px 0;\r\n    display: inline-block;\r\n    border: 1px solid #ccc;\r\n    box-sizing: border-box;\r\n    margin-left: 2%;\r\n    margin-top: 5vh;\r\n}\r\n\r\nbutton {\r\n    background-color: #4CAF50;\r\n    color: white;\r\n    padding: 14px 20px;\r\n    margin: 8px 0;\r\n    border: none;\r\n    cursor: pointer;\r\n    width: 100%;\r\n    margin-top:5vh;\r\n}\r\n\r\nbutton:hover {\r\n    opacity: 0.8;\r\n}\r\n\r\n.cuenta {\r\n    margin-left: 80vh;\r\n    margin-top: 5vh; \r\n}\r\n\r\n.cancelbtn {\r\n    width: auto;\r\n    padding: 10px 18px;\r\n    background-color: #f44336;\r\n}\r\n\r\n.aceptbtn {\r\n    width: auto;\r\n    padding: 10px 18px;\r\n    background-color: #3664F4;\r\n}\r\n\r\n.imgcontainer {\r\n    text-align: center;\r\n    margin: 24px 0 12px 0;\r\n}\r\n\r\nimg.avatar {\r\n    width: 40%;\r\n    border-radius: 50%;\r\n}\r\n\r\n.container {\r\n    padding: 16px;\r\n}\r\n\r\nspan.psw {\r\n    float: right;\r\n    padding-top: 16px;\r\n}\r\n\r\n/* Change styles for span and cancel button on extra small screens */\r\n\r\n@media screen and (max-width: 300px) {\r\n    span.psw {\r\n       display: block;\r\n       float: none;\r\n    }\r\n    .cancelbtn {\r\n       width: 100%;\r\n    }\r\n}\r\n\r\n#snackbar {\r\n    visibility: hidden;\r\n    min-width: 250px;\r\n    margin-left: -125px;\r\n   \r\n    color: #fff;\r\n    text-align: center;\r\n    border-radius: 2px;\r\n    padding: 16px;\r\n    position: fixed;\r\n    z-index: 1;\r\n    left: 50%;\r\n    bottom: 30px;\r\n    font-size: 17px;\r\n}\r\n\r\n#snackbar.Ganador {\r\n    background-color: #059F2F;\r\n}\r\n\r\n#snackbar.Perdedor {\r\n    background-color: #2271b3;\r\n}\r\n\r\n#snackbar.show {\r\n    visibility: visible;\r\n    -webkit-animation: fadein 0.5s, fadeout 0.5s 2.5s;\r\n    animation: fadein 0.5s, fadeout 0.5s 2.5s;\r\n}\r\n\r\n.ingrese {\r\n    font-size: 30px;\r\n    margin-left: 35%;\r\n}\r\n\r\n@-webkit-keyframes fadein {\r\n    from {bottom: 0; opacity: 0;} \r\n    to {bottom: 30px; opacity: 1;}\r\n}\r\n\r\n@keyframes fadein {\r\n    from {bottom: 0; opacity: 0;}\r\n    to {bottom: 30px; opacity: 1;}\r\n}\r\n\r\n@-webkit-keyframes fadeout {\r\n    from {bottom: 30px; opacity: 1;} \r\n    to {bottom: 0; opacity: 0;}\r\n}\r\n\r\n@keyframes fadeout {\r\n    from {bottom: 30px; opacity: 1;}\r\n    to {bottom: 0; opacity: 0;}\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
/***/ "./src/app/componentes/tateti/celda.ts":
/*!*********************************************!*\
  !*** ./src/app/componentes/tateti/celda.ts ***!
  \*********************************************/
/*! exports provided: MARCA_JUGADOR, Celda */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MARCA_JUGADOR", function() { return MARCA_JUGADOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Celda", function() { return Celda; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

const MARCA_JUGADOR = { JUGADOR: "O", COMPU: "X" };
class Celda {
    get marca() {
        return this._marca;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("div#tablero {\r\n    width:310px;\r\n    height:310px; \r\n    padding:0px; \r\n    border: 7px solid #999; \r\n    background-color:white; \r\n    margin: 20px auto; \r\n    cursor:pointer;\r\n}\r\n\r\ndiv#tablero div {\r\n    width:100px;\r\n    height:100px;\r\n    float:left; \r\n    margin:0px; \r\n    font-size: 90px; \r\n    text-align:center;\r\n}\r\n\r\n.celda1,.celda2,.celda3,.celda4,.celda5,.celda6 { \r\n    border-bottom: 5px solid black;\r\n}\r\n\r\n.celda1,.celda2,.celda4,.celda5,.celda7,.celda8 {\r\n    border-right: 5px solid black;\r\n}\r\n\r\ndiv#tablero > div:hover {\r\n    background-color:#ddd;\r\n}\r\n\r\ndiv#consola {\r\n    width:310px;\r\n    height:30px; \r\n    padding:7px; \r\n    border: \r\n    5px solid #999; \r\n    background-color:white; \r\n    margin: 10px auto; \r\n    text-align:center; \r\n    color:darkgreen;\r\n}\r\n\r\n.celda{\r\n    width:70px;height: 120px;\r\n}\r\n\r\n.tatetiValue{\r\n    color: #FFF;\r\n    text-align: center;\r\n    font:  100px arial, Serif;\r\n    text-shadow: 2px 2px 2px rgb(0, 0, 0);\r\n    content: 'O';\r\n}\r\n\r\nbutton {\r\n    background-color: #4CAF50;\r\n    color: white;\r\n    padding: 14px 20px;\r\n    margin: 8px 0;\r\n    border: none;\r\n    cursor: pointer;\r\n    width: 100%;\r\n    margin-top:5vh;\r\n}\r\n\r\n@media screen and (max-width: 300px) {\r\n    span.psw {\r\n       display: block;\r\n       float: none;\r\n    }\r\n    .cancelbtn {\r\n       width: 100%;\r\n    }\r\n}\r\n\r\n#snackbar {\r\n    visibility: hidden;\r\n    min-width: 250px;\r\n    margin-left: -125px;\r\n    color: #fff;\r\n    text-align: center;\r\n    border-radius: 2px;\r\n    padding: 16px;\r\n    position: fixed;\r\n    z-index: 1;\r\n    left: 50%;\r\n    bottom: 30px;\r\n    font-size: 17px;\r\n}\r\n\r\n#snackbar.Ganador {\r\n    background-color: #059F2F;\r\n}\r\n\r\n#snackbar.Perdedor {\r\n    background-color: #2271b3;\r\n}\r\n\r\n#snackbar.show {\r\n    visibility: visible;\r\n    -webkit-animation: fadein 0.5s, fadeout 0.5s 2.5s;\r\n    animation: fadein 0.5s, fadeout 0.5s 2.5s;\r\n}\r\n\r\n@-webkit-keyframes fadein {\r\n    from {bottom: 0; opacity: 0;} \r\n    to {bottom: 30px; opacity: 1;}\r\n}\r\n\r\n@keyframes fadein {\r\n    from {bottom: 0; opacity: 0;}\r\n    to {bottom: 30px; opacity: 1;}\r\n}\r\n\r\n@-webkit-keyframes fadeout {\r\n    from {bottom: 30px; opacity: 1;} \r\n    to {bottom: 0; opacity: 0;}\r\n}\r\n\r\n@keyframes fadeout {\r\n    from {bottom: 30px; opacity: 1;}\r\n    to {bottom: 0; opacity: 0;}\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let TatetiComponent = TatetiComponent_1 = class TatetiComponent {
    ...
    juegaJugador(indiceMarcado) {
        if (this.turno && !this.celdas[indiceMarcado].marca) {
            ...
            this.verificar(this.marcadaJugador, TatetiComponent_1.GANA_JUGADOR);
            if (this.ganaJugador == TatetiComponent_1.JUEGO_SIGUE) {
    ...
    juegaCompu() {
        ...
        if (this.celdasSinMarcar.length > 0) {
            ...
            this.verificar(this.marcadaCompu, TatetiComponent_1.GANA_COMPU);
            if (this.ganaJugador == TatetiComponent_1.JUEGO_SIGUE) {
                this.turno = true;
    ...
    mostrarMensaje(mensaje = "este es el mensaje", ganador = false) {
        this.mensaje = mensaje;
        var x = document.getElementById("snackbar");
        if (ganador) {
            x.className = "show Ganador";
    ...
    verificar(celdasMarcadas, jugador) {
        if (celdasMarcadas.length > 2) {
            celdasMarcadas.sort((primero, segundo) => {
                let retorno = 0;
                if (primero > segundo) {
                    retorno = 1;
                }
    ...
    resetearJuego() {
        ...
        this.turno = true;
        for (let i = 0; i < 9; i++) {
            this.celdas.push(new _celda__WEBPACK_IMPORTED_MODULE_2__["Celda"]());
        }
    }
    ngOnInit() {
    }
